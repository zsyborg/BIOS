...
You may also upload an archive like .png, gif, ZIP, RAR, or 7z containing your textures, materials, & mesh.</p>
  ...
  <div className='grid grid-flow-row justify-center w-full'>
    ...
    <SelectType/>
      <TextField size="small" id="rs" variant="outlined" label="Rendering Software" />
      <TextField size="small" id="ver" variant="outlined" label="Version" />
    <p className='text-sm'>Delete</p>
        ...
        <div className='grid grid-flow-row w-full text-left my-4 formPanel p-2'>
          ...
          <div className='grid grid-flow-row grid-cols-3 justify-center items-center text-center my-4'>
                <TextField size="small" id="rs" variant="outlined" label="Data Url" />
...
{/* First Section Ends */}
                ...
                <div class="grid grid-rows-2 my-4 formPanel p-3">
                  ...
                  <div class="grid grid-cols-3 justify-center">
                      ...
                      <TextField size="small" label="Texture Name" />
...
{/* Second Section Ends */}
                ...
                <div className='basis-1/3 flex-row text-left p-3  my-4'>
                    ...
                    <div className='flex flex-col justify-start my-6 formPanel p-3'>
                          ...
                          <TextField size="small" id="ver" variant="outlined" label="Name (person/org/username)" />
                          <TextField size="small" id="ver" variant="outlined" label="Email (institute pref.)" />
                          <TextField size="small" id="ver" variant="outlined" label="Social URL" />
                          </div>

                          <div className='grid grid-cols-3 grid-flow-col gap-3'>
                          <TextField size="small" id="ver" variant="outlined" label="Sci Collab" />
                          <TextField size="small" id="ver" variant="outlined" label="Role" />
                          <TextField size="small" id="ver" variant="outlined" label="Collaboration Description (who, why, what, how)" />
                      </div>
                    ...
                    <div className='grid grid-flow-row justify-startmb-3 my-4 formPanel p-3'>
                         ...
                         <SelectType name='select use case'/>
                          <TextField size="small" id="ver" variant="outlined" label="Model / Software Name" />
                          </div>
                    ...
                    <div className='flex flex-col justify-start my-4 formPanel p-3'>
                          ...
                          <TextField size="small" id="ver" variant="outlined" label="Aniimation Name" />
                          <TextField size="small" id="ver" variant="outlined" label="Total Frames" />
                          <TextField size="small" id="ver" variant="outlined" label="FPS" />
                          </div>

                          <div className='grid grid-cols-2 grid-flow-col my-3'>

                          <TextField size="small" id="ver" variant="outlined" label="Duration" />
